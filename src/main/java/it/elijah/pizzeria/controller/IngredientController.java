...
public class IngredientController {
  ...
  @PostMapping("/create")
  public String postMethodName(@Valid @ModelAttribute("ingrediente") Ingredient ingrediente, BindingResult bindingResult, Model model) {
      ...
      if(ingrediente.getIngredient() != null) {
        ...
        if(ingredienteFiltrato != null) {
          bindingResult.addError(new ObjectError("Errore di inserimento", "E' già presente un ingrediente con questo nome"));
        }
